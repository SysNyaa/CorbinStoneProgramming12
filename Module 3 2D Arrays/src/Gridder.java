...
public class Gridder extends javax.swing.JFrame 
    ...
    private void initComponents() {
        ...
        jButton1.setText("Random 100 White");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
                // Turn 100 random squares white with for loop

                for (int i = 0; i < 100; i++) {
                    int ranRow = (int) (Math.random() * gridCount);
                    int ranCol = (int) (Math.random() * gridCount);
                    grid[ranCol][ranRow] = 1;
                }
                draw();
            }
        });

        jButton2.setText("Random Column");
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
                // Clear the whole grid then whiteout the top half
                int halfRowCount = gridCount / 2;

                clearGrid();

                for (int row = 0; row < halfRowCount; row++) {
                    for (int col = 0; col < gridCount; col++) {
                        grid[col][row] = 1; // Color the top half white
                    }
                }
        ...
        jButton4.setText("Count White Squares");
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
                // Count white squares on the grid and output as text
                int count = 0;
                ...
                textInfo.setText("Number of white squares: " + Integer.toString(count));
            }
        });

        jButton5.setText("Replace with Cross");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {
                // Clear the grid and replace it with a white X from corner to corner
                clearGrid(); // Clear the grid

                for (int i = 0; i < gridCount; i++) {
                    grid[i][i] = 1; // Top-left to bottom-right diagonal
                    grid[i][gridCount - i - 1] = 1; // Bottom-left to top-right diagonal
                }
        ...
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
                // Invert the grid white to black, black to white
                for (int row = 0; row < gridCount; row++) {
                    for (int col = 0; col < gridCount; col++) {
                        // Inverse the value of each cell
        ...
        jButton7.setText("2 White Adjacent Turns White");
        jButton7.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
                // Turns any square adjacent to two white squares white
                int[][] temp = new int[gridCount][gridCount]; // Create a temporary grid

                // Copy contents of the original grid into the temporary grid
                for (int row = 0; row < gridCount; row++) {
                    for (int col = 0; col < gridCount; col++) {
                ...
                // Scan the grid to determine which black squares should turn white
                for (int row = 1; row < gridCount - 1; row++) {
                    for (int col = 1; col < gridCount - 1; col++) {
                        if (temp[col][row] == 0) { // If the current cell is black
                            int whiteCount = 0; // Count of adjacent white cells

                            // Check all eight adjacent cells for white
                            if (temp[col - 1][row - 1] == 1) whiteCount++;
                            if (temp[col][row - 1] == 1) whiteCount++;
                            if (temp[col + 1][row - 1] == 1) whiteCount++;
                            if (temp[col - 1][row] == 1) whiteCount++;
                            if (temp[col + 1][row] == 1) whiteCount++;
                            if (temp[col - 1][row + 1] == 1) whiteCount++;
                            if (temp[col][row + 1] == 1) whiteCount++;
                            if (temp[col + 1][row + 1] == 1) whiteCount++;

                            // If two adjacent cells are white, turn this cell white
                            if (whiteCount == 2) {
                                grid[col][row] = 1;
                            }
                        }
        ...
        jButton8.setText("Shift Grid Left");
        jButton8.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {
                // Shifts the entire grid one column to the left
                int[][] temp = new int[gridCount][gridCount]; // Create a temporary grid
                ...
                // Move the first column to the last one
                for (int row = 0; row < gridCount; row++) {
                    temp[gridCount - 1][row] = grid[0][row];
                }

                // Update the grid with the shifted grid
                for (int col = 0; col < gridCount; col++) {
                    for (int row = 0; row < gridCount; row++) {
        ...
        jButton9.setText("Rotate 90 Right");
        jButton9.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                for (int col = 0; col < gridCount; col++) {
                    for (int row = 0; row < gridCount; row++) {
                        temp[col][row] = grid[gridCount - 1 - row][col];
                    }
                }

                // Update the grid with rotated grid
                for (int col = 0; col < gridCount; col++) {
                    for (int row = 0; row < gridCount; row++) {
                        grid[col][row] = temp[col][row];
                    }
